...
TEST(RecoverTest, OLAPRecover)
{
  ...
  std::fstream fs;
  std::string meta_file_path = std::string("/Users/yili/Documents/cpp-learn/graduation-project/miniob/db/sys") +
                               common::FILE_PATH_SPLIT_STR + "stu.table";
  ...
  CLogManager *clog_manager_ = new CLogManager("/Users/yili/Documents/cpp-learn/graduation-project/miniob/db/sys");
