...
public:
  ...
  virtual RC update_entry(
      const char *old_record, const char *new_record, const RID *rid, bool need_to_del_old, bool need_to_ins_new) = 0;
  virtual bool entry_exist(const char*record) = 0;
