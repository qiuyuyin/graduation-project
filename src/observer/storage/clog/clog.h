...
#define FIELD_NAME_MAX_LEN 20  // 假定字段名最长不超过20字节
...
enum CLogType { REDO_ERROR = 0, REDO_MTR_BEGIN, REDO_MTR_COMMIT, REDO_INSERT, REDO_DELETE, REDO_UPDATE, REDO_APSYNCDE };
